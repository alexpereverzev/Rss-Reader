...
public class RssHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        if (qName.equals("item"))
            ...
            parsingData=true;
        else if (qName.equals("enclosure") || qName.equals("media:content") || qName.equals("image")) {
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if (currentItem != null) {
            ...
            if (parsingTitle)
                ...
                currentItem.setDescription(new String(ch, start, ch.length));
            else if(parsingData)
                currentItem.setData(new String(ch, start, length));
